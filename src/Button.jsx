  ...
  if (variant === "restart") {
    return (
      <button className={baseClasses.join(" ")} onClick={props.onClick}>
        <img src="/Tic_Tac_Toe/icon-restart.svg" alt="restart-icon" />
      </button>
    );
    ...
    return (
      ...
      >
        {value === "X" && (
          <img className="visible" src="/Tic_Tac_Toe/icon-x.svg" alt="icon-x" />
        )}
        {value === "O" && (
          <img className="visible" src="/Tic_Tac_Toe/icon-o.svg" alt="icon-o" />
        )}

        {value === "" && hoverX === "visible" && (
          <img
            className="visible"
            src="/Tic_Tac_Toe/icon-x-outline.svg"
            alt="icon-x-hover"
          />
        )}
        {value === "" && hoverO === "visible" && (
          <img
            className="visible"
            src="/Tic_Tac_Toe/icon-o-outline.svg"
            alt="icon-o-hover"
          />
        )}
      </button>
